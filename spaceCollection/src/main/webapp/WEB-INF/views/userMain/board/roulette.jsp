  ...
  <div var="num" class="couponBox">
	 <!--   <button id="generateButton" onclick="generateCoupon()" >랜덤 쿠폰 발급</button> -->
	   <p id="couponDisplay" ></p>
		...
		<button id="generateButton"  onclick="generateCoupon()" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
		  쿠폰 번호 확인
		</button>
  </div>
</section>
...
function generateCoupon() {
    ...
    if (!isRRotateExecuted) {
        ...
        // rRotate가 이미 실행된 경우 여기에 추가 작업을 수행합니다.

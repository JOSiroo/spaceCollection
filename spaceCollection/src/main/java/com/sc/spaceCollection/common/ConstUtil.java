...
public interface ConstUtil {
	...
	String FILE_UPLOAD_PATH_TEST="D:\\lecture\\workspace_list\\spring_ws\\spherb\\src\\main\\webapp\\pds_upload";
	
	//관리자 페이지 - 상품 등록시 상품 이미지 저장 경로
	String IMAGE_FILE_UPLOAD_PATH="pd_images";
	String IMAGE_FILE_UPLOAD_PATH_TEST="D:\\lecture\\workspace_list\\spring_ws\\spherb\\src\\main\\webapp\\pd_images";
